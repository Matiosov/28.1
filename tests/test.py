...
def test_autoriz_valid_email_pass(selenium):
    """TК-001 Тест авторизации с валидными (правильными)значениями e-mail и паролем."""
...
def test_autoriz_invalid_email_pass(selenium, incor_email, incor_passw):
    """TК-002, TК-003 "Проверка аутентификации пользователя с невалидным (не верным)email и паролем:
